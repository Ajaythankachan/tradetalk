...
$(".testimonial-content").owlCarousel({
    ...
    dots: true,
    nav: true,
    navText: ["<img data-aos='fade-up' data-aos-duration='1500' data-aos-offset='100' src='img/Algo/left.png'>", "<img data-aos='fade-up' data-aos-duration='1500' data-aos-offset='100' src='img/Algo/right.png'>"],
    mouseDrag: true,
    autoplay: false,
...
$(".feature-content").owlCarousel({
    ...
    dots: true,
    nav: true,
    navText: ["<img data-aos='fade-up' data-aos-duration='500' src='img/Algo/left.png'>", "<img data-aos='fade-up' data-aos-duration='500' src='img/Algo/right.png'>"],
    mouseDrag: true,
    autoplay: false,
    autoplayTimeout: 4000,
    smartSpeed: 800,
